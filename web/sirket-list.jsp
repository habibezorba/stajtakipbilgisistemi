...
<body>
	...
	<div class="row">
		...
		<div class="container" style="font-style:normal; color: white;" >
			<h3 class="text-center">Şirket Listesi</h3>
			<hr>
			<div class="container text-left">

				<a href="<%=request.getContextPath()%>/yeniSirket" class="btn btn-success" style="background-color:#ff5a00;" >Yeni Şirket Ekle</a>
			</div>
			<br>
				...
				<tbody>
					...
					<c:forEach var="sirket" items="${listSirket}">
						...
						<tr>
							...
							<td><c:out value="${sirket.adres}" /></td>
							<td >    <a style=" color:#00FF00;" href="sirketDuzenle?id=<c:out value='${sirket.id}' />"  >Düzenle</a>
