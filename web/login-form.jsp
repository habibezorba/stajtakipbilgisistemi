...
<body>
    <header>    
        ...
        <p 
           style=" background-color: #ff5a00; " class="solid">SİVAS CUMHURİYET ÜNİVERSİTESİ STAJ TAKİP SİSTEMİ</p>
        <div>
		...
		<div class="card">
			<div class="card-body">
				<div class="row" id="userTypeSelection" style="display:block">
					<div class="col" style="background-color: #ff5a00; border: 1px solid lightgray; border-radius: 10px; padding: 10px; text-align: center;cursor:pointer" onclick="setUserType(1)">
						<div class="row">
							<div class="col">
					...
					<div class="col" style="background-color: #ff5a00; border: 1px solid lightgray; border-radius: 10px; padding: 10px; text-align: center;cursor:pointer" onclick="setUserType(2)">
						<div class="row">
							<div class="col">
				...
				<form action="loginUser" method="post" id="loginForm" style="display:none">
					<span class="text-secondary" onclick="changeLoginType()" style="cursor:pointer"><i class="fa fa-arrow-left"> </i>  Change Login Type </span>
					<caption>
					...
					<button type="submit" class="btn btn-success"  style="background-color: #ff5a00;" >GİRİŞ</button>
