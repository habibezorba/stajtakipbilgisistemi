...
<body>
	...
	<div class="row">
		<div class="container">
                    <h3 class="text-center" style="font-style:normal; color: white">Danışman Bilgileri</h3>
			<hr>
			<br>
				...
				<tbody>
					<c:forEach var="user" items="${listDanisman}">
						<tr>
							<td><c:out value="${user.id}" /></td>
							<td><c:out value="${user.ad}" /></td>
							<td><c:out value="${user.soyad}" /></td>
							<td><c:out value="${user.email}" /></td>
							<td><c:out value="${user.bolum.ad}" /></td>
							<td><a style=" color:#00FF00;" href="danismanDuzenle?id=<c:out value='${user.id}' />">Düzenle</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a style=" color:#ee0000;"
								href="danismanSil?id=<c:out value='${user.id}' />">Sil</a></td>
						</tr>
					</c:forEach>
