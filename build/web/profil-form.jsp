		...
		<div class="card">
			<div class="card-body">
				...
				<div class="row pt-3">
					...
					<c:if test="${loggedOgrenci != null}">
						<a class="btn btn-success" style="background-color: #ff5a00;" href="ogrenciDuzenle?id=<c:out value='${loggedOgrenci.id}' />">Bilgilerimi Düzenle</a>
					</c:if>
                                                
					<c:if test="${loggedDanisman != null}">
						<a class="btn btn-success" style="background-color:#ff5a00;" href="danismanDuzenle?id=<c:out value='${loggedDanisman.id}' />">Bilgilerimi Düzenle</a>
					</c:if>
					</div>
