...
<body>
	...
	<div class="row">
		<div class="container">
			<h3 class="text-center" style="font-style:normal; color: white">Öğrenci Bilgileri</h3>
			<hr>
			<br>
				...
				<tbody>
					<c:forEach var="ogrenci" items="${listOgrenci}">
						<tr>
							<td><c:out value="${ogrenci.id}" /></td>
							<td><c:out value="${ogrenci.ad}" /></td>
							<td><c:out value="${ogrenci.soyad}" /></td>
							<td><c:out value="${ogrenci.email}" /></td>
							<td><c:out value="${ogrenci.bolum.ad}" /></td>
							<td><c:out value="${ogrenci.danisman.ad}" /> <c:out value="${ogrenci.danisman.soyad}" /></td>
							<td><a style=" color:#00FF00;" href="ogrenciDuzenle?id=<c:out value='${ogrenci.id}' />">Düzenle</a>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;</td>
