...
<body>
	...
	<div class="row">
		<div class="container">
			<h3 class="text-center" style="font-style: normal; color: white;">Staj Başvuru Listesi</h3>
			<hr>
			<div class="container text-left">
                            <a href="<%=request.getContextPath()%>/yeniStajbasvuru" class="btn btn-success" style="background-color:#ff5a00;">Yeni Staj Başvurusu Ekle</a>
			</div>
			<br>
				...
				<tbody>
					<c:forEach var="stajBasvuru" items="${listStajbasvuru}">
						<tr>
							<td><c:out value="${stajBasvuru.id}" /></td>
							<td><c:out value="${stajBasvuru.ogrenci.ad}" /> <c:out value="${stajBasvuru.ogrenci.soyad}" /></td>
							<td><c:out value="${stajBasvuru.danisman.ad}" /> <c:out value="${ogrenci.danisman.soyad}" /></td>
							<td><c:out value="${stajBasvuru.sirket.ad}" /></td>
							<td><c:out value="${stajBasvuru.baslangicTarihi}" /></td>
							<td><c:out value="${stajBasvuru.bitisTarihi}" /></td>
							<td><c:out value="${stajBasvuru.getKabulDurumuText()}" /></td>
                                                        <td><a href="stajbasvuruDuzenle?id=<c:out value='${stajBasvuru.id}' />">Düzenle </a>
                                                            &nbsp;&nbsp;&nbsp;&nbsp; <a
                                                                href="stajbasvuruSil?id=<c:out value='${stajBasvuru.id}' />">Sil </a>
                                                        </td>
