 ...
 */
package stajtakipsistemi.objects;
...
public class User {
	...
	public User(String ad, String soyad, String telefon, String email, String sifre, Boolean isManager, Integer cinsiyet,  Date dogumTarihi, Date iseBaslamaTarihi) {
		super();
		this.ad = ad;
		this.soyad = soyad;
	...
	public User(int id, String ad, String soyad, String telefon, String email, String sifre, Boolean isManager, Integer cinsiyet,  Date dogumTarihi, Date iseBaslamaTarihi) {
		super();
		this.id = id;
		this.ad = ad;
		this.soyad = soyad;
