 ...
 */
package stajtakipsistemi.jspservlet;
...
import stajtakipsistemi.database.BolumDAO;
import stajtakipsistemi.database.DanismanDAO;
import stajtakipsistemi.database.FakulteDAO;
import stajtakipsistemi.database.OgrenciDAO;
import stajtakipsistemi.database.SirketDAO;
import stajtakipsistemi.database.StajBasvuruDAO;
import stajtakipsistemi.database.StajDefteriDAO;

import stajtakipsistemi.objects.Bolum;
import stajtakipsistemi.objects.Danisman;
import stajtakipsistemi.objects.Fakulte;
import stajtakipsistemi.objects.Ogrenci;
import stajtakipsistemi.objects.Sirket;
import stajtakipsistemi.objects.StajBasvuru;
import stajtakipsistemi.objects.StajDefteri;
...
public class UserServlet extends HttpServlet {
	...
	private void listSirket(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException, ServletException {
		List<Sirket> listSirket = new SirketDAO().selectAllSirket();
	...
	private void showEditSirketForm(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, ServletException, IOException {
		int id = Integer.parseInt(request.getParameter("id"));
		Sirket existingSirket = new SirketDAO().selectSirket(id);
		RequestDispatcher dispatcher = request.getRequestDispatcher("sirket-form.jsp");
	...
	private void insertSirket(HttpServletRequest request, HttpServletResponse response) 
		...
		Sirket newSirket = new Sirket(ad, adres);
		new SirketDAO().insertSirket(newSirket);
	...
	private void updateSirket(HttpServletRequest request, HttpServletResponse response) 
		...
		Sirket newSirket = new Sirket(id, ad, adres);
		new SirketDAO().updateSirket(newSirket);
		response.sendRedirect("sirketListele");
	}
